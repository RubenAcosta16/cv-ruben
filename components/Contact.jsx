...
export default function Contact({ theme }) {
  ...
  return (
    <div id="contact" className="flex-center relative lg:top-[-112px]">
      ...
      <div
        className={`flex flex-col w-[690px] gap-4 px-[70px] pb-[50px] ${poppins.className}  z-20`}
      >
        {/* usar next ui */}

        <div className="flex justify-between flex-col gap-8">
          <div>
            <h1 className="text-[56px] font-extrabold strongText relative  mt-3">
              Contact
            </h1>
            <p className="text-stone-300 text-[18px]">
              Email: 1511ruben@gmail.com
            </p>
            <p className="text-stone-300 text-[18px]">Chihuahua Mexico</p>
          </div>
    ...
    <div className="hidden md:block z-10">
      ...
      >
        <motion.div
          ...
          className=""
        >
          <img src="/blob (4).svg" alt="" className="w-[400px] h-[400px]  " />
        </motion.div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-[210px] left-[-150px]   "
      >
        <motion.div
          id="blobs-1"
          style={{
